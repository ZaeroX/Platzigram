package com.example.victorferrada.platzigram.adapter;
...
import com.example.victorferrada.platzigram.view.PictureDetailActivity;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

/**
 * Created by Victor on 11-10-2017.
 */
...
public class PictureAdapterRecyclerView extends  RecyclerView.Adapter<PictureAdapterRecyclerView.PictureViewHolder> {
    ...
    public class PictureViewHolder extends RecyclerView.ViewHolder{
        ...
        public PictureViewHolder(View itemView) {
            ...
            likeNumberCard  = (TextView) itemView.findViewById(R.id.likeCardNumber);
